...
public class BearChestLayer extends GeoRenderLayer<BearEntity> {

    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Primal_Main.MOD_ID, "textures/entity/bear/grizzly_bear_barrels.png");

    public BearChestLayer(GeoRenderer<BearEntity> entityRendererIn) {
