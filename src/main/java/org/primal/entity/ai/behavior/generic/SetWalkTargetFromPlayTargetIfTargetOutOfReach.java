...
public class SetWalkTargetFromPlayTargetIfTargetOutOfReach {
    ...
    public static BehaviorControl<Mob> create(Function<LivingEntity, Float> speedModifier) {
        return BehaviorBuilder.create(
            mobInstance -> mobInstance.group(
                        ...
                        mobInstance.present(Primal_MemoryModuleTypes.NEAREST_PLAY_MOB.get()),
...
//                                positionTracker.set(new EntityTracker(target, true));
                                positionTracker.set(new BlockPosTracker(target.getOnPos().below(20)));
