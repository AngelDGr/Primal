...
public class CattailFeature extends Feature<RandomPatchCustomConfig> {
    public CattailFeature(final Codec<RandomPatchCustomConfig> configCodec) {
        super(configCodec);
    }
    ...
    public boolean place(final @NotNull FeaturePlaceContext<RandomPatchCustomConfig> context) {
        ...
        BlockState defaultStateLongReeds= Primal_Blocks.CATTAILS.get().defaultBlockState();
